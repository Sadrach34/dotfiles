...
QtObject {
  ...
  property var _appsJsonWatcher: FileView {
    ...
    onFileChanged: {
      reload()
      appsConfigRefresh.restart()
    }
    onLoaded: appsConfigRefresh.restart()
  }

  property var _appsConfigRefresh: Timer {
    id: appsConfigRefresh
    interval: 120
    onTriggered: service._applyAppsConfig()
  }

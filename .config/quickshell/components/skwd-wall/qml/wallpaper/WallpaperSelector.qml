...
Scope {
  ...
  Item {
    ...
    FilterBar {
      ...
      onReloadDbRequested: service.reloadDatabaseNow()
    ...
    WallhavenBrowser {
      id: whBrowser
      anchors.centerIn: parent
      width: Math.min(cardContainer.width - 20, (selectorPanel.screen ? selectorPanel.screen.width : cardContainer.width) - 40)
      z: 6
      colors: wallpaperSelector.colors
      whService: whService

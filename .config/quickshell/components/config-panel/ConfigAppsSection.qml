                ...
                Rectangle {
                  ...
                  TextInput {
                    ...
                    onTextEdited: {
                      ...
                      var resolved = text.replace("~", root.panel.homeDir)
                      if (resolved !== "") SkwdServices.WallpaperApplyService.applyThemeFromImage(resolved)
                      root.panel.hasUnsavedChanges = true
                      root.panel.appsDataChanged()
                    }
              ...
              Rectangle {
                ...
                Image {
                  ...
                  source: {
                    ...
                    if (!bg) return ""
                    bg = bg.replace("~", root.panel.homeDir)
                    return "file://" + bg
                  }

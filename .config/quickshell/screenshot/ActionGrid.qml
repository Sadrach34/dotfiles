...
FocusScope {
    ...
    Rectangle {
        ...
        StyledRect {
            ...
            Behavior on t1x { NumberAnimation { duration: Config.animDuration / 3; easing.type: Easing.OutSine } }
            Behavior on t1y { NumberAnimation { duration: Config.animDuration / 3; easing.type: Easing.OutSine } }
            Behavior on t1w { NumberAnimation { duration: Config.animDuration / 3; easing.type: Easing.OutSine } }
            Behavior on t1h { NumberAnimation { duration: Config.animDuration / 3; easing.type: Easing.OutSine } }
            ...
            Behavior on t2x { NumberAnimation { duration: Config.animDuration; easing.type: Easing.OutSine } }
            Behavior on t2y { NumberAnimation { duration: Config.animDuration; easing.type: Easing.OutSine } }
            Behavior on t2w { NumberAnimation { duration: Config.animDuration; easing.type: Easing.OutSine } }
            Behavior on t2h { NumberAnimation { duration: Config.animDuration; easing.type: Easing.OutSine } }
                    ...
                    Button {
                        ...
                        contentItem: Item {
                            ...
                            Text {
                                ...
                                color: actionButton.pressed ? Styling.srItem("overprimary") : (index === root.currentIndex ? Colors.primary : Colors.overBackground)
